...
SECRET_KEY = environ.get('SECRET_KEY') or 'django-insecure-2f9k^h7f#@g$49ga@obto&f+h$ag0$yvm&basuol^kd6rx*spi'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'app/templates/errors')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGGING = {
    ...
    'handlers': {
        'file1': {
            ...
            'filename': os.path.join(LOGGING_DIR, 'django.log'),  # Имя файла лога
        },
        'file2': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': os.path.join(LOGGING_DIR, 'django_sql_queries.log'),
        },
    },
    'loggers': {
        'django': {
...
if not DEBUG:
    DATABASES = {
        'default': {
            ...
            'HOST': environ.get('MYSQL_HOST'),   # Или адрес вашего сервера MySQL
